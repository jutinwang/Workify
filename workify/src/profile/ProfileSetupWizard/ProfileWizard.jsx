...
const STEP_DEFS = {
  contact: {
    ...
    validate: (s) => validateContact(s.contact),
  },
  education: {
    label: "Education",
    Component: EducationStep,
    validate: (s) => validateEducation(s.education),
  },
  experience: { label: "Experience", Component: ExperienceStep },
  files: {
    label: "Files",
    Component: FilesStep,
    validate: (s) => validateFiles(s.files),
  },
  ...
  company: {
    ...
    validate: (s) => validateCompany(s.company),
  },
  recruiter: {
    label: "Recruiter",
...
export default function ProfileWizard() {
  ...
  // Merge signup data into initial state
